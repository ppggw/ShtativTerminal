...
public:
    ...
    QPointF MouseClick;
    uint8_t HomePosition_Change;
    uint8_t ComandPostPosition_Change;
    uint8_t FlyTo_Change;
    uint8_t TAKEOFF_Change;
    uint8_t WP1_Change;
    uint8_t WP2_Change;
    uint8_t LANDING_Change;
...
private slots:
    ...
    void SetComandPostPosition(void);
    void MissionItem(void);
    void MissionLanding(void);
    void MissionTakeoff(void);
    void MissionWP1(void);
    void MissionWP2(void);
protected:
    void doTileLayout();
